...
private:
	...
	static string aircraftFilePath;
	
	// JSON operations
	static json loadAllAircraftData();
	static void saveAllAircraftData(const json& data);
	json getAircraftData() const;
	void updateAircraftData(const json& updates);
